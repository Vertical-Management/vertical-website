...
export default function ContactWidget({ label, title, href, icon, meta }: ContactWidgetProps) {
  return (
    <article className="ng-glass ng-squircle p-4 transition-transform duration-300 ease-out hover:-translate-y-[2px] active:translate-y-0">
      ...
      <a
        className="ng-text-title mt-3 block text-white text-[clamp(15px,2.4vw,18px)] font-[650] leading-[1.28] break-words underline-offset-4 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent rounded-md active:opacity-90"
        href={href}
      >
        {title}
      </a>
