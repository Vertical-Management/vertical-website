...
export function ServicesCTA() {
  return (
    <section className="relative overflow-hidden bg-surface-inverse py-section text-paper" data-theme="inverse">
      <Grain strong />
        ...
        <div className="grid items-end gap-10 lg:grid-cols-12">
          <div className="lg:col-span-8">
            ...
            <h2 className="mt-4 font-display text-display-lg text-paper">
              Elige tu bloque.
              <br />
              <span className="text-accent-lime">Inserta coin.</span>
            </h2>
            <p className="mt-6 max-w-md text-lead text-white/55">
              Branding, digital, motion o estrategia — o el combo completo.
              Empezamos por la idea, no por la plantilla.
            </p>
          </div>
